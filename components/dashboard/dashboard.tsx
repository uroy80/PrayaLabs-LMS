...
import { BookOpen, User, Calendar, Search, Settings, LogOut } from "lucide-react"
import { BookSearch } from "./book-search"
import { UserProfile } from "./user-profile"
import { BorrowedBooks } from "./borrowed-books"
import { Reservations } from "./reservations"
import { AuthorTest } from "../debug/author-test"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="debug" className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">System Debug Tools</h2>
              <p className="text-gray-600 mb-6">Test API endpoints and system functionality</p>
              <AuthorTest />
            </div>
          </TabsContent>
        </Tabs>
